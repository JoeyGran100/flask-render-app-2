...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://wingsdatingapp1_render_example_user:mw67HKBZhMeB6MT0D2D9faxFJDNRjHrA@dpg-cv5dmc7noe9s73eh7ohg-a.frankfurt-postgres.render.com/wingsdatingapp1_render_example"
